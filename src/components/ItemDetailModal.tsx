...
export default function ItemDetailModal({ 
    ...
    return (
        <div className="fixed inset-0 z-[100] flex animate-fade-in items-center justify-center p-4 md:pl-72">
            {/* Backdrop with heavy blur */}
            <div className="absolute inset-0 bg-white/80 dark:bg-black/90 backdrop-blur-sm dark:backdrop-blur-xl" />

            {/* Modal Container */}
            <div
                className="relative w-full max-w-[360px] h-auto max-h-[90vh] glass-card-strong overflow-y-auto animate-scale-in border border-black/5 dark:border-white/10 shadow-2xl rounded-[32px] z-10 flex flex-col"
            ...
            >
                ...
                <div className="p-8 flex-1 flex flex-col">
                    ...
                    <div className={`p-5 mb-8 rounded-2xl border backdrop-blur-md space-y-5 relative overflow-hidden group transition-all duration-500 ${
                        theme === 'dark' 
                        ...
                        <div className="flex justify-between items-end px-1">
                            <div className="w-1/3 flex flex-col items-start gap-1">
                                <span className={`text-sm font-black truncate transition-colors ${theme === 'dark' ? 'text-white' : 'text-text-primary'}`}>{format(displayProductValue)}</span>
